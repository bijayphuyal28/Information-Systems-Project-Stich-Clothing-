...
$query = 'SELECT max(contactInTouchId) as id FROM contactintouch';
...
$sql = "INSERT INTO contactintouch ".
       "(contactInTouchId,name,phoneNo,email,messageText) ".
       "VALUES ".
       "('$uid','$name','$phoneno','$email','$message')";
